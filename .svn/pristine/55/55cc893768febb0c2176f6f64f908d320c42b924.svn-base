...
(function () {
  ...
  Menus.prototype.createHelpLink = function (href) {
    ...
    link.style.cssText =
      "color:blue;text-decoration:underline;margin-left:8px;cursor:help;";
  ...
  Menus.prototype.init = function () {
      ...
      if (
        ...
        function driveObjToTempDlg(item) {
          return {
            ...
            title: item.title,
            imgUrl: item.thumbnailLink,
            changedBy: item.lastModifyingUserName,
        ...
        var tempDlg = new TemplatesDialog(
          editorUi,
          function (templateXml, title, infoObj) {
            var templateLibs = infoObj.libs,
              templateClibs = infoObj.clibs;
            ...
            editorUi.pickFolder(
              ...
              editorUi.stateArg == null || editorUi.stateArg.folderId == null
            );
          },
          null,
          null,
    ...
    var rulerAction = editorUi.actions.addAction("ruler", function () {
      ...
      if (editorUi.ruler != null) {
        ...
        editorUi.ruler = new mxDualRuler(
          editorUi,
          editorUi.editor.graph.view.unit
        );
        editorUi.refresh();
      }
    });
    ...
    if (window.mxFreehand) {
      editorUi.actions.put(
        "insertFreehand",
        new Action(mxResources.get("freehand") + "...", function (evt) {
          if (graph.isEnabled()) {
            if (this.freehandWindow == null) {
              var withBrush = !mxClient.IS_IE && !mxClient.IS_IE11;
              this.freehandWindow = new FreehandWindow(
                editorUi,
      ...
      new Action(mxResources.get("formatPdf") + "...", function () {
        if (
          ...
          if (editorUi.pdfPageExport && !noPages) {
            var allPages = editorUi.addRadiobox(
              div,
              "pages",
              mxResources.get("allPages"),
              true
            );
            var pagesRadio = editorUi.addRadiobox(
              div,
              "pages",
            ...
            var selection = editorUi.addRadiobox(
              div,
              "pages",
              mxResources.get("selectionOnly"),
              false,
            ...
            var crop = editorUi.addCheckbox(
              div,
              mxResources.get("crop"),
              false,
              true
            );
            var grid = editorUi.addCheckbox(
              div,
          ...
          var transparentBkg = null,
            include = null;

          if (EditorUi.isElectronApp || isDrawioWeb) {
            include = editorUi.addCheckbox(
              div,
          ...
          if (isDrawioWeb) {
            transparentBkg = editorUi.addCheckbox(
              div,
          ...
          var dlg = new CustomDialog(
            ...
            mxUtils.bind(this, function () {
                ...
                pageRange =
                  ...
                  (from != currentPage || to != currentPage)
                    ? {
                        ...
                        to: Math.max(0, Math.min(pageCount - 1, to - 1)),
                      }
                    : null;
              }
              ...
              editorUi.downloadFile(
                ...
                !crop.checked,
                transparentBkg != null && transparentBkg.checked,
                null,
                null,
                grid.checked,
                include != null && include.checked,
                pageRange
              );
            }),
            null,
    ...
    editorUi.actions.put(
      "pageBackgroundImage",
      new Action(mxResources.get("backgroundImage") + "...", function () {
      ...
      new Action(mxResources.get("formatJpg") + "...", function () {
        if (editorUi.isExportToCanvas()) {
          ...
          editorUi.showRemoteExportDialog(
            ...
            mxUtils.bind(
              this,
              function (ignoreSelection, editable, tranaparent, scale, border) {
                editorUi.downloadFile(
                  "jpeg",
                  null,
                  null,
    ...
    editorUi.actions.put(
      "about",
      new Action(
        mxResources.get("about") + " " + EditorUi.VERSION + "...",
        function () {
          if (
            editorUi.isOffline() ||
            mxClient.IS_CHROMEAPP ||
      ...
      menu.addItem(
        ...
        function () {
          ...
          function doLayout() {
            if (
              typeof mxOrgChartLayout === "undefined" &&
              !editorUi.loadingOrgChart &&
              !editorUi.isOffline(true)
            ) {
              if (
                editorUi.spinner.spin(document.body, mxResources.get("loading"))
              ) {
        ...
        mxUtils.bind(this, function () {
          ...
          editorUi.executeLayout(function () {
            layout.execute(
              ...
              !graph.isSelectionEmpty() ? graph.getSelectionCells() : null
            );
          }, false);
        }),
        parent
      ...
      new Menu(
        mxUtils.bind(this, function (menu, parent) {
          if (!mxClient.IS_CHROMEAPP && editorUi.isOffline()) {
            ...
            item.style.backgroundColor = Editor.isDarkMode()
              ? "#505759"
              : "whiteSmoke";
              ...
              mxUtils.bind(this, function (e) {
                ...
                if (e.keyCode == 13 && term.length > 0) {
                  this.editorUi.openLink(
                    "https://www.diagrams.net/search?src=" +
                      (EditorUi.isElectronApp
                        ? "DESKTOP"
          ...
          if (editorUi.pages != null) {
            var buttons = [
              [
                "Snapshot",
                function (evt, input) {
                  snapshot = editorUi.getPagesForNode(
                    mxUtils.parseXml(editorUi.getFileData(true)).documentElement
                  );
                  dlg.textarea.value =
                    "Snapshot updated " +
            ...
            if (file.shadowPages != null) {
              console.log(
                "Checksum shadowPages: " +
                  editorUi.getHashValueForPages(file.shadowPages)
              );
              console.log(
                "diff shadowPages/ownPages",
                editorUi.diffPages(file.shadowPages, file.ownPages)
              );
              console.log(
                "diff ownPages/shadowPages",
                editorUi.diffPages(file.ownPages, file.shadowPages)
              );
              console.log(
                "diff theirPages/shadowPages",
                editorUi.diffPages(file.theirPages, file.shadowPages)
              );
            }
    ...
    editorUi.actions.put(
      ...
      new Action(mxResources.get("formatSvg") + "...", function () {
        editorUi.showEmbedImageDialog(
          ...
          mxResources.get("image"),
          true,
          "https://www.diagrams.net/doc/faq/embed-svg.html"
        );
      })
    );
    ...
    editorUi.actions.put(
      ...
      new Action(mxResources.get("notion") + "...", function () {
        ...
        editorUi.showPublishLinkDialog(
          ...
          true,
          "https://www.diagrams.net/blog/drawio-notion",
          footer
        );
      })
    );
    ...
    editorUi.actions.put(
      "downloadDesktop",
      new Action(mxResources.get("downloadDesktop") + "...", function () {
        ...
        if (
          ...
          graph.startEditingAtCell(
            insertVertex(
              ...
              40,
              20,
              "text;html=1;resizable=0;autosize=1;" +
    ...
    editorUi.actions.put(
      "insertRectangle",
      new Action(mxResources.get("rectangle"), function () {
        if (
          graph.isEnabled() &&
          !graph.isCellLocked(graph.getDefaultParent())
        ) {
    ...
    editorUi.actions.put(
      "insertEllipse",
      new Action(mxResources.get("ellipse"), function () {
        if (
          graph.isEnabled() &&
          !graph.isCellLocked(graph.getDefaultParent())
        ) {
    ...
    editorUi.actions.put(
      "insertRhombus",
      new Action(mxResources.get("rhombus"), function () {
        if (
          graph.isEnabled() &&
          !graph.isCellLocked(graph.getDefaultParent())
        ) {
        ...
        mxUtils.bind(this, function (menu, parent) {
          ...
          if (isLocalStorage || mxClient.IS_CHROMEAPP) {
            ...
            if (
              ...
              this.addLinkToItem(
                item,
                "https://www.diagrams.net/doc/faq/scratchpad"
              );
            }
          }
          ...
          if (urlParams["embed"] == "1") {
            ...
            if (file != null && file.constructor == DriveFile) {
              ...
              if (
                ...
                this.addLinkToItem(
                  item,
                  "https://www.diagrams.net/doc/faq/synchronize"
                );
              }
            ...
            if (file != null && file.constructor == DriveFile) {
              this.addMenuItems(
                menu,
                ["new", "-", "rename", "makeCopy", "moveToFolder"],
                parent
              );
            } else {
              if (
            ...
            if (
              ...
              if (
                ...
                (!/(\.html)$/i.test(filename) && !/(\.svg)$/i.test(filename))
              ) {
    ...
    ChangeExtFonts.prototype.execute = function () {
      ...
      for (
        var i = 0;
        this.previousExtFonts != null && i < this.previousExtFonts.length;
        i++
      ) {
        this.ui.editor.graph.addExtFont(
          this.previousExtFonts[i].name,
          this.previousExtFonts[i].url
        );
      }
        ...
        mxUtils.bind(this, function (menu, parent) {
                ...
                mxEvent.addListener(
                  ...
                  mxUtils.bind(this, function (evt) {
                    if (urlParams["ext-fonts"] != "1") {
                      ...
                      var extFonts = mxUtils.clone(
                        this.editorUi.editor.graph.extFonts
                      );
          ...
          if (urlParams["ext-fonts"] != "1") {
            ...
            if (this.customFonts.length > 0) {
              for (var i = 0; i < this.customFonts.length; i++) {
                var name = this.customFonts[i].name,
                      ...
                      try {
                        ...
                        if (urlParams["ext-fonts"] != "1") {
                          ...
                          if (type != "s") {
                            ...
                            this.editorUi.editor.graph.addExtFont(
                              fontName,
                              fontUrl
                            );
                          }
