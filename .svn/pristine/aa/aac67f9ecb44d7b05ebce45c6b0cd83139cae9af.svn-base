...
; (function () {
    ...
    if (EditorUi.enableLogging && urlParams['dev'] != '1') {
      try {
        ...
        // DocumentClosedError seems to be an FF bug an can be ignored for now
          ...
          message != null &&
          message.indexOf('DocumentClosedError') < 0
        ) {
  ...
  EditorUi.prototype.downloadFile = function (
    ...
    try {
      ...
      var basename = this.getBaseFilename(
        format == 'remoteSvg' ? false : !currentPage
      )
      var filename =
        basename +
      ...
      try {
        ...
        if (EditorUi.enableLogging && !this.isOffline()) {
          try {
            EditorUi.logEvent({
              category:
                'ERROR-LOAD-FILE-' + (file != null ? file.getHash() : 'none'),
  ...
  EditorUi.prototype.libraryLoaded = function (
    ...
    if (file.isEditable()) {
            ...
            function () {
              if (spinBtn != null && spinBtn.parentNode != null) {
                ...
                title.style.paddingRight =
                  buttons.childNodes.length * btnWidth + 'px'
              }
            }
          )
      ...
      var addCells = mxUtils.bind(this, function (cells, bounds, evt, title) {
        ...
        var xml = Graph.compress(
          mxUtils.getXml(this.editor.graph.encodeCells(cells))
        )
  ...
  EditorUi.initTheme = function () {
    ...
    if (urlParams['sketch'] == '1') {
      if (typeof Menus !== 'undefined') {
        Menus.prototype.defaultFonts = Menus.prototype.defaultFonts.concat(
          Editor.sketchFonts
        )
      }
  ...
  EditorUi.prototype.showBackgroundImageDialog = function (apply, img) {
    apply =
      apply != null
        ? apply
        : mxUtils.bind(this, function (image, failed) {
          if (!failed) {
    ...
    if (this.spinner.spin(document.body, mxResources.get('export'))) {
      try {
        ...
        if (bg == null && transparentBackground == false) {
          bg = keepTheme
            ? this.editor.graph.defaultPageBackgroundColor
            : '#ffffff'
        }
  ...
  EditorUi.prototype.showPublishLinkDialog = function (
    ...
    if (file != null && file.constructor == window.DriveFile && !hideShare) {
      ...
      helpLink =
        helpLink != null
          ? helpLink
          : 'https://www.diagrams.net/doc/faq/google-drive-publicly-publish-diagram'
      ...
      helpLink =
        helpLink != null
          ? helpLink
          : 'https://www.diagrams.net/doc/faq/publish-diagram-as-link'
    }
    ...
    var delayed = function () {
      try {
        ...
        mermaid.mermaidAPI.render(
          'geMermaidOutput-' + new Date().getTime(),
          data,
          function (svg) {
            try {
    ...
    if (this.isSettingsEnabled()) {
      if (urlParams['sketch'] == '1') {
        this.doSetSketchMode(
          mxSettings.settings.sketchMode != null && urlParams['rough'] == null
        ...
        mxUtils.bind(this, function (evt) {
          ...
          if (graph.isEnabled()) {
            ...
            if (files.length > 0) {
              ...
              if (
                urlParams['embed'] != '1' &&
                (mxEvent.isShiftDown(evt) || noImport)
              ) {
                if (
                  !mxEvent.isShiftDown(evt) &&
                  noImport &&
  ...
  //定义复用的方法 llz
  EditorUi.prototype.reUseXml = function () {
    var cells = null
            ...
            if (data == null) {
              ...
              if (
                ...
                var tempDlg = new TemplatesDialog(
                  this,
                  function (xml, filename, itemInfo) {
                    ...
                    parent.postMessage(
                      JSON.stringify({
                        ...
                        name: filename,
                        tempUrl: itemInfo.url,
                        libs: itemInfo.libs,
                        builtIn:
                          itemInfo.info != null &&
                          itemInfo.info.custContentId != null,
                        message: data,
                      }),
                      '*'
                    )
                  ...
                  enableRecentDocs
                    ? mxUtils.bind(
                      this,
                      function (recentReadyCallback, error, username) {
                        this.remoteInvoke(
                          'getRecentDiagrams',
                          [username],
                          null,
                  ...
                  enableSearchDocs
                    ...
                    : null,
                  mxUtils.bind(this, function (obj, callback, error) {
                    this.remoteInvoke(
                      'getFileContent',
                      [obj.url],
                      null,
  ...
  EditorUi.prototype.addEmbedButtons = function () {
    if (this.menubar != null && urlParams['embedInline'] != '1') {
      ...
      div.style.paddingTop =
        uiTheme == 'atlas' || urlParams['atlas'] == '1' ? '2px' : '0px'
      ...
      if (urlParams['noSaveBtn'] == '1') {
        ...
        button.setAttribute(
          'title',
          mxResources.get('save') + ' (' + Editor.ctrlKey + '+S)'
        )
      ...
      div.style.right =
        uiTheme == 'atlas' || urlParams['atlas'] == '1' ? '42px' : '52px'
    }
  }
