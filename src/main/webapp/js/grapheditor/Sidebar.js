...
Sidebar.prototype.addGeneralPalette = function(expand)
{
	...
	field.vertex = true;
	//修改左侧工具栏通用模块里的图形选项 llz
	var fns = [
	 	// this.createVertexTemplateEntry('rounded=0;whiteSpace=wrap;html=1;', 120, 60, '', 'Rectangle', null, null, 'rect rectangle box'),
	 	this.createVertexTemplateEntry('user_transition;rounded=0;whiteSpace=wrap;html=1;strokeColor=#969696;', 160, 100, mxResources.get('userTransition'), 'Rounded Rectangle', null, null, 'rounded rect rectangle box','user_transition'),
		...
		this.createVertexTemplateEntry('start;ellipse;whiteSpace=wrap;html=1;aspect=fixed;fillColor=#52c41a;strokeColor=null;fontColor=#ffffff;', 80, 80, mxResources.get('start'), 'Circle', null, null, 'circle','start'),
		this.createVertexTemplateEntry('end;ellipse;whiteSpace=wrap;html=1;aspect=fixed;fillColor=#ff5500;strokeColor=null;fontColor=#ffffff;', 80, 80, mxResources.get('end'), 'Circle', null, null, 'circle','end'),
	 	...
	 	this.createVertexTemplateEntry('gateway_explicit;rhombus;whiteSpace=wrap;html=1;strokeColor=#969696;', 80, 80, mxResources.get('gatewayExplicit'), 'Diamond', null, null, 'diamond rhombus if condition decision conditional question test','gateway_explicit'),
...
Sidebar.prototype.addUmlPalette = function(expand)
{
	...
	var fns = [
		...
		this.createVertexTemplateEntry('verticalAlign=top;align=left;overflow=fill;html=1;',180, 90,
			'<div style="box-sizing:content-box;width:100%;background:#e4e4e4;padding:2px;">Tablename</div>' +
 ...
 */
Sidebar.prototype.createThumb = function(cells, width, height, parent, title, showLabel, showTitle,type)
{
 ...
 */
//添加type属性 llz
Sidebar.prototype.createItem = function(cells, title, showLabel, showTitle, width, height, allowCellsInserted, showTooltip,type)
{
	...
	this.createThumb(originalCells, this.thumbWidth, this.thumbHeight,
		elt, title, showLabel, showTitle, width, height,type);
...
Sidebar.prototype.createVertexTemplateEntry = function(style, width, height, value, title, showLabel, showTitle, tags,type)
{
	...
	return this.addEntry(tags, mxUtils.bind(this, function()
 	{
 		return this.createVertexTemplate(style, width, height, value, title, showLabel, showTitle,type);
 	}));
}
 ...
 * Creates a drop handler for inserting the given cells.
 */
Sidebar.prototype.createVertexTemplate = function(style, width, height, value, title, showLabel, showTitle, allowCellsInserted, showTooltip,type)
{
	var cells = [new mxCell((value != null) ? value : '', new mxGeometry(0, 0, width, height), style)];
	cells[0].vertex = true;

	return this.createVertexTemplateFromCells(cells, width, height, title, showLabel, showTitle, allowCellsInserted, showTooltip,type);
};
 ...
 * Creates a drop handler for inserting the given cells.
 */
Sidebar.prototype.createVertexTemplateFromCells = function(cells, width, height, title, showLabel, showTitle, allowCellsInserted, showTooltip,type)
{
	...
	return this.createItem(cells, title, showLabel, showTitle, width, height, allowCellsInserted, showTooltip,type);
};
...
{	
	return this.createItem(cells, title, showLabel, (showTitle != null) ? showTitle : true, width, height, allowCellsInserted, showTooltip,type);
};
