...
App = function (editor, container, lightbox) {
  ...
  const fileInit = window.top['drawio']['fileInit']()|| {}
              if (!fileInit.data) {
                fileInit.data = `<mxfile host="dev.doscs.com" modified="2022-04-15T07:39:09.501Z" agent="5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/100.0.4896.75 Safari/537.36 Edg/100.0.1185.39" etag="wgncf-aVDtylelZU3uY7" version="17.2.2" type="device">
      <diagram id="C5RBs43oDa-KdzZeNtuy">
        <mxGraphModel dx="1190" dy="625" grid="1" gridSize="10" guides="1" tooltips="1" connect="1" arrows="1" fold="1" page="0" pageScale="1" pageWidth="827" pageHeight="1169" math="0" shadow="0">
          <root>
          </root>
        </mxGraphModel>
      </diagram>
  ...
  window.top['drawio']['handleOk'] = (cell)=>{
    this.editor.graph.cellEditor.stopEditing(cell);
 ...
 */
App.TRELLO_JQUERY_URL =
  window.DRAWIO_BASE_URL + '/js/jquery/jquery-3.3.1.min.js'
 ...
 */
App.SIMPLE_PEER_URL =
  window.DRAWIO_BASE_URL + '/js/simplepeer/simplepeer9.10.0.min.js'
  ...
  if (window.mxscript != null) {
    ...
    if (
      ...
      if (scripts != null && scripts.length > 0) {
        ...
        if (
          CryptoJS.MD5(content).toString() != '1f536e2400baaa30261b8c3976d6fe06'
        ) {
          console.log(
      ...
      if (scripts != null && scripts.length > 1) {
        ...
        if (
          CryptoJS.MD5(content).toString() != 'd53805dd6f0bbba2da4966491ca0a505'
        ) {
          console.log(
            'Change main script MD5 in the previous line:',
            CryptoJS.MD5(content).toString()
          )
    ...
    if (urlParams['plugins'] != '0' && urlParams['offline'] != '1') {
      ...
      if (
        ...
        var warning =
          'The page has requested to load the following plugin(s):\n \n {1}\n \n Would you like to load these plugin(s) now?\n \n NOTE : Only allow plugins to run if you fully understand the security implications of doing so.\n'
        ...
        for (var i = 0; i < plugins.length && local; i++) {
          if (
            plugins[i].charAt(0) != '/' &&
            plugins[i].substring(0, tmp.length) != tmp
          ) {
            local = false
          }
        }
        ...
        if (
          ...
          mxUtils.confirm(
            mxResources
              .replacePlaceholders(warning, [plugins.join('\n')])
              .replace(/\\n/g, '\n')
          )
        ) {
              ...
              if (plugins != null) {
                for (var i = 0; i < plugins.length; i++) {
                  if (!trustedPlugins[plugins[i]]) {
                    throw (
                      new Error(
                        mxResources.get('invalidInput') + ' "' + plugins[i]
                      ) + '"'
                    )
                  }
                }
    ...
    try {
      if (mxSettings.settings != null) {
        document.body.style.backgroundColor =
          uiTheme == 'dark' || mxSettings.settings.darkMode
            ? Editor.darkColor
            : '#ffffff'
 ...
 *
 */
App.prototype.chevronUpImage = !mxClient.IS_SVG
 ...
 *
 */
App.prototype.chevronDownImage = !mxClient.IS_SVG
  ? IMAGE_PATH + '/chevron-down.png'
 ...
 *
 */
App.prototype.formatShowImage = !mxClient.IS_SVG
  ? IMAGE_PATH + '/format-show.png'
 ...
 *
 */
App.prototype.formatHideImage = !mxClient.IS_SVG
  ? IMAGE_PATH + '/format-hide.png'
 ...
 *
 */
App.prototype.fullscreenImage = !mxClient.IS_SVG
  ? IMAGE_PATH + '/fullscreen.png'
  : 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABAAAAAQAQMAAAAlPW0iAAAABlBMVEUAAAAAAAClZ7nPAAAAAXRSTlMAQObYZgAAABpJREFUCNdjgAAbGxAy4AEh5gNwBBGByoIBAIueBd12TUjqAAAAAElFTkSuQmCC'
...
App.prototype.init = function () {
  ...
  if (
    (uiTheme == 'atlas' || urlParams['atlas'] == '1') &&
    this.menubar != null
  ) {
  ...
  if (mxEvent.isAltDown(evt)) {
    ...
    if (mode == App.MODE_GOOGLE) {
      if (
        file != null &&
        file.desc != null &&
        file.desc.parents != null &&
        file.desc.parents.length > 0 &&
        !mxEvent.isShiftDown(evt)
      ) {
        // Opens containing folder
        this.openLink(
          'https://drive.google.com/drive/folders/' + file.desc.parents[0].id
        )
      ...
      if (file != null && file.stat != null && file.stat.path_display != null) {
        var url =
          'https://www.dropbox.com/home/Apps/drawio' + file.stat.path_display
    ...
    // Redirects old url URL parameter to new #U format
      ...
      var done = mxUtils.bind(this, function () {
        ...
        if (
           ...
           * 加载数据
           */
          var xml = `<mxfile host="localhost" modified="2022-04-15T02:11:12.731Z" agent="5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/100.0.4896.75 Safari/537.36 Edg/100.0.1185.39" version="@DRAWIO-VERSION@" etag="cUUVH0uek1J2iruueVvr"><diagram id="TMVAbKXdkNXbSFzEaa_s">UzV2zq1wL0osyPDNT0nNUTV2VTV2LsrPL4GwciucU3NyVI0MMlNUjV1UjYwMgFjVyA2HrCFY1qAgsSg1rwSLBiADYTaQg2Y1AA==</diagram></mxfile>`
          doLoadFile(xml)
...
App.prototype.showSplash = function (force) {
  ...
  //   const fileInit = window.top['drawioFileInit'] || {}
  //   if (!fileInit.data) {
  //     fileInit.data = `<mxfile host="dev.doscs.com" modified="2022-04-15T07:39:09.501Z" agent="5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/100.0.4896.75 Safari/537.36 Edg/100.0.1185.39" etag="wgncf-aVDtylelZU3uY7" version="17.2.2" type="device">
  //     <diagram id="C5RBs43oDa-KdzZeNtuy" name="Page-1">
  //       <mxGraphModel dx="1190" dy="625" grid="1" gridSize="10" guides="1" tooltips="1" connect="1" arrows="1" fold="1" page="1" pageScale="1" pageWidth="827" pageHeight="1169" math="0" shadow="0">
  //         <root>
  //         </root>
  //       </mxGraphModel>
  //     </diagram>
  //   </mxfile>`
  //   }
  //   const file = new LocalFile(this, fileInit.data, fileInit.title, this.mode);
  ...
  if (file != null) {
    ...
    if (
      ...
      var dlg = new CreateDialog(
        this,
        filename,
        mxUtils.bind(this, function (name, mode, input) {
...
App.prototype.fetchAndShowNotification = function (target, subtarget) {
  ...
  var processNotif = mxUtils.bind(this, function (notifs) {
    ...
    var lastRead =
      localStorage != null ? parseInt(localStorage.getItem(lsReadFlag)) : true
...
App.prototype.updateHeader = function () {
  if (this.menubar != null) {
    ...
    var logo = !mxClient.IS_SVG
      ? "url('" + IMAGE_PATH + "/logo-white.png')"
      : uiTheme == 'dark'
    ...
    this.toggleFormatElement.setAttribute(
      'title',
      mxResources.get('formatPanel') + ' (' + Editor.ctrlKey + '+Shift+P)'
    )
    ...
    this.toggleFormatElement.style.right =
      uiTheme != 'atlas' && urlParams['embed'] != '1' ? '30px' : '10px'
    ...
    this.fullscreenElement.style.right =
      uiTheme != 'atlas' && urlParams['embed'] != '1' ? '50px' : '30px'
    ...
    if (urlParams['embed'] != '1') {
      ...
      mxEvent.addListener(
        ...
        'click',
        mxUtils.bind(this, function (evt) {
          EditorUi.logEvent({ category: 'TOOLBAR-ACTION-', action: 'toggleUI' })
...
App.prototype.updateUserElement = function () {
  if (
    ...
    (this.trello == null || !this.trello.isAuthorized())
  ) {
    ...
    if (this.userElement == null) {
      ...
      this.userElement.style.backgroundImage =
        'url(' + IMAGE_PATH + '/expanded.gif)'
      ...
      mxEvent.addListener(
        ...
        mxUtils.bind(this, function (evt) {
          if (this.userPanel == null) {
            ...
            div.style.top =
              this.userElement.clientTop +
              this.userElement.clientHeight +
              6 +
              'px'
            div.style.zIndex = 5
          ...
          if (this.userPanel.parentNode != null) {
            ...
            if (this.drive != null) {
              ...
              if (driveUsers.length > 0) {
                ...
                var closeFile = mxUtils.bind(
                  this,
                  function (callback, spinnerMsg) {
                    var file = this.getCurrentFile()
            ...
            var addUser = mxUtils.bind(
              this,
              function (user, logo, logout, label) {
                if (user != null) {
                  if (connected) {
