...
(function () {
	...
	if (window.StyleFormatPanel != null) {
		...
		StyleFormatPanel.prototype.addEditOps = function (div) {
			...
			btn4 = mxUtils.button(mxResources.get('editProcess'), mxUtils.bind(this, function (evt) {
				this.editorUi.actions.get('editProcess').funct();
			}));

			btn4.setAttribute('title', '流程设置');
			btn4.style.width = '210px';
			btn4.style.marginTop = '2px';
